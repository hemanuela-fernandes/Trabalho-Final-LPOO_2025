...
public class Teste {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6 - Validar Projeto");
            System.out.println("7 - Exibir Perfis");
    ...
    private static void cadastrarProjeto() {
        ...
        if (tipo == 1) {
            ...
            double valorMeta = doubleValido();
            Meta<Double> meta = new Meta<Double>(valorMeta);

            p = new ProjetoSocial(nome, desc, prioridade, meta);

        } else {
            List<String> itens = new ArrayList<>();
            System.out.println("Digite a meta de itens:");
            int metaItens = intValido();
            Meta<Integer> meta = new Meta<>(metaItens);
    ...
    public static void validarProjeto() {
        try {  
        	System.out.println("Acesso do Admin:");
    ...
    private static void fazerDoacao() {
        ...
        if (tipo == 1) {
            ...
            Double valor = doubleValido();

            p.realizarDoacao(d, valor);

        } else {
            System.out.print("Quantidade de Itens: ");
            int quantidade = intValido();

            p.realizarDoacao(d, quantidade);
        }
    }
    ...
    private static void exibirPerfis() {
    	...
    	try {  
            ...
            do {
                System.out.println("\n=== Escolha o perfil a ser visualizado ===");
            ...
            System.out.println("Erro ao ver perfis: " + e.getMessage());
        }
    ...
    private static void exibirDoador(){
            ...
            doadores.get(index).exibirPerfil();
   	
    	
    }
    
    private static void exibirVoluntario(){
            ...
            System.out.println("Escolha o Voluntário:");
            for (int i = 0; i < voluntarios.size(); i++)
                System.out.println(i + " - " + voluntarios.get(i).getNome());

            int index = sc.nextInt();
            sc.nextLine();
            
            voluntarios.get(index).exibirPerfil();	    	
